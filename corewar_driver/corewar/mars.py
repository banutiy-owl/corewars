...
from corewar_driver.corewar.core import Core, DEFAULT_INITIAL_INSTRUCTION
from corewar_driver.corewar.redcode import *
        ...
        for warrior in self.warriors:
            if warrior.task_queue:
                ...
                if ir.a_mode == IMMEDIATE:
                    ...
                    if ir.a_mode != DIRECT:
                        ...
                        if ir.a_mode == PREDEC_A:
                            ...
                            self.core.set_modified(pc + wpa, copy(warrior.id))
                ...
                if ir.a_mode == POSTINC_A:
                    ...
                    self.core.set_modified(pip, copy(warrior.id))
                ...
                def do_arithmetic(op):
                    try:
                        if ir.modifier == M_A:
                            ...
                            self.core.set_modified(pc + wpb, copy(warrior.id))
